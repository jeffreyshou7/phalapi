...
return array(
    ...
    'servers' => array(
        'db_master' => array(                       // 服务器标记 / database identify
            ...
            'host'      => 'db1.soso.wang',             // 数据库域名 / database host
            'name'      => 'db_waakii_center',               // 数据库名字 / database name
            'user'      => 'root',                  // 数据库用户名 / database user
            'password'  => 'Sjhsjn6',                      // 数据库密码 / database password
            'port'      => 3307,                    // 数据库端口 / database port
